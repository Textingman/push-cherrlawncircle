    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-sm w-full bg-white rounded-2xl shadow-md p-8">
        <div className="flex justify-center mb-6">
          <span className="text-2xl font-bold" style={{ color: '#059669' }}>Cherrlawn Circle</span>
        </div>
        ...
        <p className="text-xs text-gray-400 text-center mt-6">Secured by Cherrlawn Circle</p>
      </div>
    </div>
  );
}
