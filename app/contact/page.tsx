            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@cherrlawncircle.com" className="text-base font-medium hover:underline" style={{ color: '#059669' }}>support@cherrlawncircle.com</a>
                ...
                <div>
                  ...
                  <p style={{ color: '#6B7280' }}>Cherrlawn Circle<br />6102 Cherrylawn Cir<br />Austin, TX 78723</p>
                </div>
                <div>
