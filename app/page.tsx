    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl font-extrabold sm:text-6xl md:text-7xl" style={{ color: '#1F2937' }}>
              ...
              <span className="block" style={{ color: '#059669' }}>for Community Resources</span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-xl" style={{ color: '#6B7280' }}>
              Get instant, unbiased guidance on community resources, assistance programs, and local services — no pressure, just honest answers.
            </p>
      ...
      <section className="py-20" style={{ backgroundColor: '#ECFDF5' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-10" style={{ color: '#6B7280' }}>Join thousands of people who trust Cherrlawn Circle for clear, unbiased guidance.</p>
